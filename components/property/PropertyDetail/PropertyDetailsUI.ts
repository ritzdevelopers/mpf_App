...
export const styles = {
  ...
  badgeRow: "absolute top-[110px] left-4 flex-row gap-2",
  badgePill:
    "flex-row items-center bg-white/90 border border-white/80 px-2.5 py-1 rounded-full shadow-sm",
  badgeDotBlue: "w-1.5 h-1.5 rounded-full bg-blue-600 mr-1.5",
  badgeDotGreen: "w-1.5 h-1.5 rounded-full bg-green-600 mr-1.5",
  badgeDotAmber: "w-1.5 h-1.5 rounded-full bg-[#d89b38] mr-1.5",
  badgeTextBlue: "text-blue-700 text-[11px] font-semibold",
  badgeTextGreen: "text-green-700 text-[11px] font-semibold",
  badgeTextAmber: "text-[#b97a1f] text-[11px] font-semibold",
